...
from train_mmlab_kie.utils import kie_models
...
# --------------------
class TrainMmlabKieWidget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = TrainMmlabKieParam()
        else:
        ...
        self.combo_model_name.setEnabled(not (self.check_expert.isChecked()))
...
# --------------------
class TrainMmlabKieWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the name of the process -> it must be the same as the one declared in the process factory class
        self.name = "train_mmlab_kie"

    def create(self, param):
        # Create widget object
        return TrainMmlabKieWidget(param, None)
